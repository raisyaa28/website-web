<div class="col-12">
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <form action="{{ route('vehicletype.update', $data->id) }}" method="POST" id="frm">
        @csrf
        @method('PUT')

        <div class="mb-3">
          <label class="form-label">Vehicle Type Name</label>
          <input type="text" class="form-control" id="nama_vehicletype"
            name="nama_vehicletype"
            value="{{ old('nama_vehicletype', $data->nama_vehicletype) }}"
            placeholder="Input Vehicle Type Name">
        </div>
        ...
        <div class="text-end">
          <a href="{{ route('vehicletype.index') }}" class="btn btn-outline-secondary me-2">
            Cancel
          </a>
